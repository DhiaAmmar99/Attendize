<div class="well">
    <p>
        Installation may make take several minutes to complete. Once you click '<b>Install Attendize</b>' the config settings will be written to this file: <b><?php echo e(base_path('.env')); ?></b>. You can manually change these settings in the future by editing this file.
    </p>
    <p>
        If the install fails be sure to check the log file in <b><?php echo e(storage_path('logs')); ?></b>. If there are no errors in the log files also <b>check other log files on your server</b>.
    </p>
    <p>
...
<?php /**PATH C:\wamp64\www\laravel\ica-backoffice\resources\views\en/Installer/Partials/Footer.blade.php ENDPATH**/ ?>