            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('couleur', $stream->couleur,array('class'=>'form-control','placeholder'=>'Enter color of your stream' )); ?>
                        ...
                        <textarea  class="form-control  editable" name="description" rows="5" ><?php echo e($stream->description); ?></textarea>
                    </div>
                </div>
            </div>
