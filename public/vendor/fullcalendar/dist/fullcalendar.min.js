...
! function(a) {
    ...
    function d(b) {
        ...
        return a.each(b, function(b, e) {
            "views" != b && (
                ...
                a.isPlainObject(e) && !/(time|duration|interval)$/i.test(b) && -1 == a.inArray(b, Va) ? (c = null, a.each(e, function(a, e) { /^(month|week|day|default|basic(Week|Day)?|agenda(Week|Day)?)$/.test(a) ? (d.views[a] || (d.views[a] = {}), d.views[a][b] = e) : (c || (c = {}), c[a] = e) }), c && (d[b] = c)) : d[b] = e)
        }), d
    }
    ...
    function k(b) {
        ...
        return b.find("> span").each(function(b, d) { var e = a(d).outerWidth();
    ...
    function l(a, b) {
        ...
        return d.css({
            ...
            left: -1
        }), c = a.outerHeight() - b.outerHeight(), d.css({ position: "", left: "" }), c
    }
    ...
    function q(a) {
        var b = a.innerWidth() - a[0].clientWidth,
            c = { left: 0, right: 0, top: 0, bottom: a.innerHeight() - a[0].clientHeight }; // is the scrollbar on the left side?
    ...
    function F(a, b, c) { var d, e; for (d = 0; d < c.length; d++)
            if (e = G(a, b, c[d])) return e;
        return 0 }

    function G(a, b, c) { return c.func ? c.func(a, b) : H(a[c.field], b[c.field]) * (c.order || 1) }

    function H(b, c) { return b || c ? null == c ? -1 : null == b ? 1 : "string" === a.type(b) || "string" === a.type(c) ? String(b).localeCompare(String(c)) : b - c : 0 }
    ...
    function R(a) { return Boolean(a.hours() || a.minutes() || a.seconds() || a.milliseconds()) }

    function S(a) { return "[object Date]" === Object.prototype.toString.call(a) || a instanceof Date }
    ...
    function V(a) { var b = function() {}; return b.prototype = a, new b }

    function W(a, b) { for (var c in a) Y(a, c) && (b[c] = a[c]) }
    // Copies over certain methods with the same names as Object.prototype methods. Overcomes an IE<=8 bug:
    // https://developer.mozilla.org/en-US/docs/ECMAScript_DontEnum_attribute#JScript_DontEnum_Bug
    function X(a, b) { var c, d, e = ["constructor", "toString", "valueOf"]; for (c = 0; c < e.length; c++) d = e[c], a[d] !== Object.prototype[d] && (b[d] = a[d]) }

    function Y(a, b) { return ab.call(a, b) }
    ...
    function _() { for (var a = 0; a < arguments.length; a++)
    ...
    function da(a) { return a.charAt(0).toUpperCase() + a.slice(1) }

    function ea(a, b) { // for .sort()
        return a - b
    }

    function fa(a) { return a % 1 === 0 }
    ...
    function ha(a, b, c) { var d, e, f, g, h, i = function() { var j = +new Date - g;
    ...
    // additional token.
    function na(a, b) { return oa(a, ta(b)) }

    function oa(a, b) { var c, d = ""; for (c = 0; c < b.length; c++) d += pa(a, b[c]); return d }
    ...
    function sa(a, b, c, d, e) { var f, g; return "string" == typeof e ? e : (f = e.token) && (g = gb[f.charAt(0)], g && c.isSame(d, g)) ? ma(a, f) : !1 }

    function ta(a) { return a in hb ? hb[a] : hb[a] = ua(a) }
    ...
    function wa(a, b) {
        ...
        return Y(b, "constructor") && (c = b.constructor), "function" != typeof c && (c = b.constructor = function() { a.apply(this, arguments) }), c.prototype = V(a.prototype), W(b, c.prototype), X(b, c.prototype), W(a, c), c
    }

    function xa(a, b) { W(b, a.prototype) }
    ...
    function za(a, b) { for (var c in a)
    ...
    function Ga(a, b) { var c, d; for (c = 0; c < b.length; c++)
    ...
    function Ja(a) { var b, c, d, e, f; for (b = 0; b < a.length; b++)
    ...
    function Na(c, d) {
        ...
        /* Header Updating
        	-----------------------------------------------------------------------------*/
        function u() { R.updateTitle(W.title) }
        ...
        function H() { T.css({ width: "100%", height: T.height(), overflow: "hidden" }) }

        function I() { T.css({ width: "", height: "", overflow: "" }) }
        /* Misc
        	-----------------------------------------------------------------------------*/
        function J() { return N }
    ...
    function Oa(b) { a.each(zb, function(a, c) { null == b[a] && (b[a] = c(b)) }) }
    // Returns moment's internal locale data. If doesn't exist, returns English.
    // Works with moment-pre-2.8
    function Pa(a) { var c = b.localeData || b.langData; return c.call(b, a) || c.call(b, "en") }
    ...
    function Ra(c) {
        ...
        function e(a, b) { I = a, M = b, S = []; var c = ++Q,
                d = P.length;
            R = d; for (var e = 0; d > e; e++) f(P[e], c) }

        function f(b, c) { g(b, function(d) { var e, f, g, h = a.isArray(b.events); if (c == Q) { if (d)
        ...
        function g(b, d) {
            ...
            if (i) a.isFunction(i) ? (H.pushLoading(), i.call(H, // this, the Calendar object
                ...
                function(a) { d(a), H.popLoading() })) : a.isArray(i) ? d(i) : d();
            else {
                var j = b.url;
                if (j) {
                    var k, l = b.success,
                    ...
                    p && (o[p] = I.format()), q && (o[q] = M.format()), c.timezone && "local" != c.timezone && (o[r] = c.timezone), H.pushLoading(), a.ajax(a.extend({}, Ab, b, { data: o, success: function(b) { b = b || []; var c = $(l, this, arguments);
                            a.isArray(c) && (b = c), d(b) }, error: function() { $(m, this, arguments), d() }, complete: function() { $(n, this, arguments), H.popLoading() } }))
                } else d()
            }
        }
        /* Sources
            ...
            if (a.isFunction(b) || a.isArray(b) ? c = { events: b } : "string" == typeof b ? c = { url: b } : "object" == typeof b && (c = a.extend({}, b)), c) {
                for (
                    ...
                    a.isArray(c.events) && (c.origArray = c.events, // for removeEventSource
                        c.events = a.map(c.events, function(a) { return s(a, c) })), d = 0; d < e.length; d++) e[d].call(H, c);
                return c
            }
        }

        function j(b) { P = a.grep(P, function(a) { return !k(a, b) }), S = a.grep(S, function(a) { return !k(a.source, b) }), N(S) }
        ...
        function p(a, b) { var c, d, e, f = s(a); if (f) { for (c = w(f), d = 0; d < c.length; d++) e = c[d], e.source || (b && (O.events.push(e), e.source = O), S.push(e)); return N(S), c } return [] }
        ...
        function q(b) {
            ...
            for (null == b ? // null or undefined. remove all events
                b = function() { return !0 } : a.isFunction(b) || (c = b + "", b = function(a) { return a._id == c }), S = a.grep(S, b, !0), d = 0; d < P.length; d++) a.isArray(P[d].events) && (P[d].events = a.grep(P[d].events, b, !0));
            N(S)
        }

        function r(b) { // not null, not undefined. an event ID
            return a.isFunction(b) ? a.grep(S, b) : null != b ? (b += "", a.grep(S, function(a) { return a._id == b })) : S
        }
        /* Event Normalization
        	-----------------------------------------------------------------------------*/
        ...
        function y(b, c, d, e, f, g) {
            ...
            return e && !e.valueOf() && (e = null), f && !f.valueOf() && (f = null), a.each(b, function(b, j) { var k, l;
                    k = { start: j.start.clone(), end: j.end ? j.end.clone() : null, allDay: j.allDay }, a.each(g, function(a) { k[a] = j[a] }), l = { start: j._start, end: j._end, allDay: d }, u(l), c ? l.end = null : f && !l.end && (l.end = H.getDefaultEventEnd(l.allDay, l.start)), e && (l.start.add(e), l.end && l.end.add(e)), f && l.end.add(f), h && !l.allDay && (e || f) && (l.start.stripZone(), l.end && l.end.stripZone()), a.extend(j, g, l), Sa(j), i.push(function() { a.extend(j, k), Sa(j) }) }),
        ...
        function A(a, b) { var d = b.source || {},
                ...
                f = _(b.overlap, d.overlap, c.eventOverlap); return D(a, e, f, b) }
        ...
        function D(a, b, c, d) {
            ...
            if (null != b) { for (e = E(b), f = !1, h = 0; h < e.length; h++)
                    if (F(e[h], a)) { f = !0; break }
                if (!f) return !1 }
        ...
        function F(a, b) { var c = a.start.clone().stripZone(),
                d = H.getEventEnd(a).stripZone(); return b.start >= c && b.end <= d }
        // Does the event's date range intersect with the given range?
        // start/end already assumed to have stripped zones :(
        function G(a, b) { var c = a.start.clone().stripZone(),
                d = H.getEventEnd(a).stripZone(); return b.start < d && b.end > c } // assumed to be a calendar
        var H = this;
        // exports
    ...
    /* Logging and Debug
    ----------------------------------------------------------------------------------------------------------------------*/
    Ta.log = function() { var a = window.console; return a && a.log ? a.log.apply(a, arguments) : void 0 }, Ta.warn = function() { var a = window.console; return a && a.warn ? a.warn.apply(a, arguments) : Ta.log.apply(Ta, arguments) };
    /* General Utilities
    ----------------------------------------------------------------------------------------------------------------------*/
    ...
    Ta.moment = function() { return ia(arguments) },
        ...
        }), Za = "_d" in b() && "updateOffset" in b, $a = Za ? function(a, c) { a._d.setTime(Date.UTC.apply(Date, c)), b.updateOffset(a, !1) } : la, _a = Za ? function(a, c) { a._d.setTime(+new Date(c[0] || 0, c[1] || 0, c[2] || 0, c[3] || 0, c[4] || 0, c[5] || 0, c[6] || 0)), b.updateOffset(a, !1) } : la;
    ...
    Ta.Class = va,
        ...
        va.mixin = function(a) { xa(this, a) };
    var ib = Ta.EmitterMixin = {
            callbackHash: null,
            on: function(a, b) { return this.loopCallbacks(a, "add", [b]), this },
            ...
            triggerWith: function(a, b, c) { return this.loopCallbacks(a, "fireWith", [b, c]), this },
            /*
            ...
            ensureCallbackObj: function(b) { return this.callbackHash || (this.callbackHash = {}), this.callbackHash[b] || (this.callbackHash[b] = a.Callbacks()), this.callbackHash[b] }
        },
            ...
            var b = 0,
                c = {
                    ...
                    /*
                    		...
                    		*/
                    getListenerNamespace: function() { return null == this.listenerId && (this.listenerId = b++), "_listener" + this.listenerId }
                };
            return c
        }(),
        kb = va.extend(jb, {
            ...
            position: function() { var b, c, d, e, f, g = this.options,
        ...
        lb = Ta.CoordCache = va.extend({
            ...
            build: function() { var a = this.forcedOffsetParentEl || this.els.eq(0).offsetParent();
            ...
            buildElHorizontals: function() { var b = [],
                    c = [];
                this.els.each(function(d, e) { var f = a(e),
                        g = f.offset().left,
                        h = f.outerWidth();
                    b.push(g), c.push(g + h) }), this.lefts = b, this.rights = c },
            // Populates the top/bottom internal coordinate arrays
            buildElVerticals: function() { var b = [],
                    c = [];
                this.els.each(function(d, e) { var f = a(e),
                        g = f.offset().top,
                        h = f.outerHeight();
                    b.push(g), c.push(g + h) }), this.tops = b, this.bottoms = c },
            // Given a left offset (from document left), returns the index of the el that it horizontally intersects.
            // If no intersection is made, or outside of the boundingRect, returns undefined.
            getHorizontalIndex: function(a) { this.ensureBuilt(); var b, c = this.boundingRect,
                    d = this.lefts,
                    e = this.rights,
            ...
            // If no intersection is made, or outside of the boundingRect, returns undefined.
            getVerticalIndex: function(a) { this.ensureBuilt(); var b, c = this.boundingRect,
                    d = this.tops,
                    e = this.bottoms,
        ...
        mb = Ta.DragListener = va.extend(jb, {
            ...
            // -----------------------------------------------------------------------------------------------------------------
            startInteraction: function(b, c) { var d = x(b); if ("mousedown" === b.type) { if (!u(b)) return;
                    b.preventDefault() }
            ...
            handleInteractionStart: function(a) { this.trigger("interactionStart", a) },
            endInteraction: function(a) { this.isInteracting && (this.endDrag(a), this.delayTimeoutId && (clearTimeout(this.delayTimeoutId), this.delayTimeoutId = null), this.destroyAutoScroll(), this.unbindHandlers(), this.isInteracting = !1, this.handleInteractionEnd(a)) },
            handleInteractionEnd: function(a) { this.trigger("interactionEnd", a) },
            // Binding To DOM
            // -----------------------------------------------------------------------------------------------------------------
            bindHandlers: function() {
                ...
                }), this.scrollEl && this.listenTo(this.scrollEl, "scroll", this.handleTouchScroll)) : this.listenTo(a(document), { mousemove: this.handleMouseMove, mouseup: this.endInteraction }), this.listenTo(a(document), {
                    selectstart: z, // don't allow selection while dragging
                    contextmenu: z
                })
            },
            unbindHandlers: function() { this.stopListeningTo(a(document)), this.scrollEl && this.stopListeningTo(this.scrollEl) },
            // Drag (high-level)
            // -----------------------------------------------------------------------------------------------------------------
            ...
            handleDragStart: function(a) { this.trigger("dragStart", a), this.initHrefHack() },
            ...
            handleDrag: function(a, b, c) { this.trigger("drag", a, b, c), this.updateAutoScroll(c) },
            endDrag: function(a) { this.isDragging && (this.isDragging = !1, this.handleDragEnd(a)) },
            handleDragEnd: function(a) { this.trigger("dragEnd", a), this.destroyHrefHack() },
            // Delay
            // -----------------------------------------------------------------------------------------------------------------
            startDelay: function(a) { var b = this;
                this.delay ? this.delayTimeoutId = setTimeout(function() { b.handleDelayEnd(a) }, this.delay) : this.handleDelayEnd(a) },
            handleDelayEnd: function(a) { this.isDelayEnded = !0, this.isDistanceSurpassed && this.startDrag(a) },
            // Distance
            // -----------------------------------------------------------------------------------------------------------------
            ...
            handleMouseMove: function(a) { this.handleMove(a) },
    ...
    */
    mb.mixin({
        ...
        updateAutoScroll: function(a) { var b, c, d, e, f = this.scrollSensitivity,
                g = this.scrollBounds,
                h = 0,
                i = 0;
    ...
    */
    var nb = mb.extend({
            ...
            handleInteractionStart: function(a) {
                ...
                this.computeCoords(), a ? (c = { left: v(a), top: w(a) }, d = c, e && (b = n(e), d = B(d, b)), this.origHit = this.queryHit(d.left, d.top), e && this.options.subjectCenter && (this.origHit && (b = A(this.origHit, b) || b), d = C(b)), this.coordAdjust = D(d, c)) : (this.origHit = null, this.coordAdjust = null),
            ...
            handleHitOver: function(a) { var b = ya(a, this.origHit);
        ...
        pb = Ta.Grid = va.extend(jb, {
            ...
            constructor: function(a) { this.view = a, this.isRTL = a.opt("isRTL"), this.elsByFill = {} },
            /* Options
            	------------------------------------------------------------------------------------------------------------------*/
            ...
            diffDates: function(a, b) { return this.largeUnit ? L(a, b, this.largeUnit) : J(a, b) },
            /* Hit Area
            	------------------------------------------------------------------------------------------------------------------*/
            ...
            dayMousedown: function(a) { this.clearDragListeners(), this.buildDayDragListener().startInteraction(a, {}) },
            dayTouchStart: function(a) { this.clearDragListeners(), this.buildDayDragListener().startInteraction(a, { delay: this.view.opt("longPressDelay") }) },
            ...
            buildDayDragListener: function() {
                var a, b, c = this,
                    ...
                    f = this.dayDragListener = new nb(this, {
                        ...
                        interactionStart: function() { a = f.origHit },
                        dragStart: function() { d.unselect() },
                        ...
                        hitOut: function() { a = null, b = null, c.unrenderSelection(), h() },
            ...
            clearDragListeners: function() { this.dayDragListener && this.dayDragListener.endInteraction(), this.segDragListener && this.segDragListener.endInteraction(), this.segResizeListener && this.segResizeListener.endInteraction(), this.externalDragListener && this.externalDragListener.endInteraction() },
            /* Event Helper
            	------------------------------------------------------------------------------------------------------------------*/
            ...
            unrenderFill: function(a) { var b = this.elsByFill[a];
            ...
            getDayClasses: function(a) { var b = this.view,
                    c = b.calendar.getNow(),
                    d = ["fc-" + Xa[a.day()]]; return 1 == b.intervalDuration.as("months") && a.month() != b.intervalStart.month() && d.push("fc-other-month"), a.isSame(c, "day") ? d.push("fc-today", b.highlightStateClass) : c > a ? d.push("fc-past") : d.push("fc-future"), d }
        });
    ...
    pb.mixin({
            ...
            bgEventSegClasses: function(a) { var b = a.event,
            ...
            handleSegClick: function(a, b) { return this.view.trigger("eventClick", a.el[0], a.event, b) },
            ...
            handleSegMouseout: function(a, b) { b = b || {}, this.mousedOverSeg && (a = a || this.mousedOverSeg, this.mousedOverSeg = null, this.view.trigger("eventMouseout", a.el[0], a.event, b)) },
            handleSegTouchStart: function(a, b) {
                ...
                f && h && (
                    ...
                    this.clearDragListeners(), c = g ? this.buildSegDragListener(a) : new mb, c._dragStart = function() { f || d.selectEvent(e) }, c.startInteraction(b, { delay: f ? 0 : this.view.opt("longPressDelay") }))
            },
            handleSegMousedown: function(a, b) { var c = this.startSegResize(a, b, { distance: 5 });!c && this.view.isEventDraggable(a.event) && (this.clearDragListeners(), this.buildSegDragListener(a).startInteraction(b, { distance: 5 })) },
            // returns boolean whether resizing actually started or not.
            // assumes the seg allows resizing.
            // `dragOptions` are optional.
            startSegResize: function(b, c, d) { return a(c.target).is(".fc-resizer") ? (this.clearDragListeners(), this.buildSegResizeListener(b, a(c.target).is(".fc-start-resizer")).startInteraction(c, d), !0) : !1 },
            /* Event Dragging
            	------------------------------------------------------------------------------------------------------------------*/
            ...
            buildSegDragListener: function(a) {
                var b, c, d, e = this,
                    ...
                    l = this.segDragListener = new nb(f, {
                        ...
                        subjectEl: j,
                        subjectCenter: !0,
                        interactionStart: function(d) { b = !1, c = new ob(a.el, { additionalClass: "fc-dragging", parentEl: f.el, opacity: l.isTouch ? null : f.opt("dragOpacity"), revertDuration: f.opt("dragRevertDuration"), zIndex: 2 }), c.hide(), c.start(d) },
                        dragStart: function(c) { b = !0, e.handleSegMouseout(a, c), e.segDragStart(a, c), f.hideEvent(k) },
                        ...
                        interactionEnd: function(g) {
                            ...
                            c.stop(!d, function() { b && (f.unrenderDrag(), f.showEvent(k), e.segDragStop(a, g)), d && f.reportEventDrop(k, d, this.largeUnit, j, g) }), e.segDragListener = null
                        }
                    });
                return l
            },
            ...
            computeEventDrop: function(a, b, c) {
                ...
                return g.hasTime() === h.hasTime() ? (d = this.diffDates(h, g), c.allDay && R(d) ? (e = { start: c.start.clone(), end: f.getEventEnd(c), allDay: !1 }, f.normalizeEventTimes(e)) : e = { start: c.start.clone(), end: c.end ? c.end.clone() : null, allDay: c.allDay }, e.start.add(d), e.end && e.end.add(d)) : e = {
                    start: h.clone(),
            ...
            externalDragStart: function(b, c) { var d, e, f = this.view;
            ...
            listenToExternalDrag: function(a, b, c) {
                var d, e = this,
                    ...
                    j = e.externalDragListener = new nb(this, {
                        interactionStart: function() { e.isDraggingExternal = !0 },
                        hitOver: function(a) {
            ...
            buildSegResizeListener: function(a, b) {
                var c, d, e = this,
                    ...
                    m = this.segResizeListener = new nb(this, {
                        scroll: f.opt("dragScroll"),
                        subjectEl: j,
                        interactionStart: function() { c = !1 },
                        dragStart: function(b) { c = !0, e.handleSegMouseout(a, b), e.segResizeStart(a, b) },
                        hitOver: function(c, h, j) { var m = e.getHitSpan(j),
                                n = e.getHitSpan(c);
            ...
            getSegSkinCss: function(a) { var b = a.event,
                    c = this.view,
                    d = b.source || {},
                    e = b.color,
                    f = d.color,
            ...
            sortEventSegs: function(a) { a.sort(ga(this, "compareEventSegs")) },
    ...
    */
    var qb = Ta.DayTableMixin = {
            ...
            renderHeadDateCellHtml: function(a, b, c) { var d = this.view; return '<th class="fc-day-header ' + d.widgetHeaderClass + " fc-" + Xa[a.day()] + '"' + (1 == this.rowCnt ? ' data-date="' + a.format("YYYY-MM-DD") + '"' : "") + (b > 1 ? ' colspan="' + b + '"' : "") + (c ? " " + c : "") + ">" + aa(a.format(this.colHeadFormat)) + "</th>" },
        ...
        rb = Ta.DayGrid = pb.extend(qb, {
            ...
            renderDates: function(a) {
                ...
                for (this.el.html(g), this.rowEls = this.el.find(".fc-row"), this.cellEls = this.el.find(".fc-day"), this.rowCoordCache = new lb({ els: this.rowEls, isVertical: !0 }), this.colCoordCache = new lb({
            ...
            renderBusinessHours: function() { var a = this.view.calendar.getBusinessHoursEvents(!0),
                    b = this.eventsToSegs(a);
                this.renderFill("businessHours", b, "bgevent") },
            // Generates the HTML for a single row, which is a div that wraps a table.
            // `row` is the row number.
            renderDayRowHtml: function(a, b) { var c = this.view,
            ...
            queryHit: function(a, b) { var c = this.colCoordCache.getHorizontalIndex(a),
            ...
            renderHelper: function(b, c) {
                ...
                return f = this.renderFgSegEls(f), d = this.renderSegRows(f), this.rowEls.each(function(b, f) { var g, h = a(f),
            ...
            renderFillRow: function(b, c, d) { var e, f, g = this.colCnt,
                    h = c.leftCol,
    ...
    rb.mixin({
            ...
            fgSegHtml: function(a, b) {
                ...
                return j.unshift("fc-day-grid-event", "fc-h-event"), a.isStart && (c = this.getEventTimeText(f), c && (l = '<span class="fc-time">' + aa(c) + "</span>")), d = '<span class="fc-title">' + (aa(f.title || "") || "&nbsp;") + "</span>", '<div class="' + j.join(" ") + '"' + (f.url ? ' href=""' : "") + (k ? ' style="' + k + '"' : "") + '><div class="fc-content">' + (this.isRTL ? d + " " + l : l + " " + d) + "</div>" + (h ? '<div class="fc-resizer fc-start-resizer" />' : "") + (i ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</div>"
        ...
        rb.mixin({
            ...
            showSegPopover: function(a, b, c, d) { var e, f, g = this,
                    h = this.view,
                    i = c.parent();
    ...
    var sb = Ta.TimeGrid = pb.extend(qb, {
        ...
        processOptions: function() { var c, d = this.view,
        ...
        getHitSpan: function(a) { var b, c = this.getCellDate(0, a.col),
        ...
        sliceRangeByTimes: function(a) { var b, c, d, e, f = []; for (c = 0; c < this.daysPerRow; c++) d = this.dayDates[c].clone(), e = { start: d.clone().time(this.minTime), end: d.clone().time(this.maxTime) }, b = I(a, e), b && (b.dayIndex = c, f.push(b)); return f },
        /* Coordinates
        	------------------------------------------------------------------------------------------------------------------*/
        ...
        /* Business Hours
        	------------------------------------------------------------------------------------------------------------------*/
        renderBusinessHours: function() { var a = this.view.calendar.getBusinessHoursEvents(),
                b = this.eventsToSegs(a);
    ...
    sb.mixin({
        ...
        renderContentSkeleton: function() { var b, c, d = ""; for (b = 0; b < this.colCnt; b++) d += '<td><div class="fc-content-col"><div class="fc-event-container fc-helper-container"></div><div class="fc-event-container"></div><div class="fc-highlight-container"></div><div class="fc-bgevent-container"></div><div class="fc-business-container"></div></div></td>';
        ...
        renderHelperSegs: function(b, c) {
            ...
            for (b = this.renderFgSegsIntoContainers(b, this.helperContainerEls), d = 0; d < b.length; d++) e = b[d], c && c.col === e.col && (f = c.el, e.el.css({ left: f.css("left"), right: f.css("right"), "margin-left": f.css("margin-left"), "margin-right": f.css("margin-right") })), g.push(e.el[0]);
        ...
        attachSegsByCol: function(a, b) { var c, d, e; for (c = 0; c < this.colCnt; c++)
                for (d = a[c], e = 0; e < d.length; e++) b.eq(c).append(d[e].el) },
        // Given the name of a property of `this` object, assumed to be an array of segments,
        // loops through each segment and removes from DOM. Will null-out the property afterwards.
        unrenderNamedSegs: function(a) { var b, c = this[a]; if (c) { for (b = 0; b < c.length; b++) c[b].el.remove();
                this[a] = null } },
        ...
        sortForwardSegs: function(a) { a.sort(ga(this, "compareForwardSegs")) },
    ...
    var tb = Ta.View = va.extend(ib, jb, {
            ...
            handleDocumentTouchStart: function(a) { this.processRangeUnselect(a) },
        ...
        ub = Ta.Scroller = va.extend({
            ...
            overflowX: null,
            overflowY: null,
            constructor: function(a) { a = a || {}, this.overflowX = a.overflowX || a.overflow || "auto", this.overflowY = a.overflowY || a.overflow || "auto" },
            render: function() { this.el = this.renderEl(), this.applyOverflow() },
            renderEl: function() { return this.scrollEl = a('<div class="fc-scroller"></div>') },
            ...
            lockOverflow: function(a) { var b = this.overflowX,
                    c = this.overflowY;
                a = a || this.getScrollbarWidths(), "auto" === b && (b = a.top || a.bottom || this.scrollEl[0].scrollWidth - 1 > this.scrollEl[0].clientWidth ? "scroll" : "hidden"), "auto" === c && (c = a.left || a.right || this.scrollEl[0].scrollHeight - 1 > this.scrollEl[0].clientHeight ? "scroll" : "hidden"), this.scrollEl.css({ "overflow-x": b, "overflow-y": c }) },
            // Getters / Setters
            // -----------------------------------------------------------------------------------------------------------------
            setHeight: function(a) { this.scrollEl.height(a) },
            getScrollTop: function() { return this.scrollEl.scrollTop() },
            setScrollTop: function(a) { this.scrollEl.scrollTop(a) },
            getClientWidth: function() { return this.scrollEl[0].clientWidth },
            getClientHeight: function() { return this.scrollEl[0].clientHeight },
            getScrollbarWidths: function() { return q(this.scrollEl) }
        }),
        vb = Ta.Calendar = va.extend({
            ...
            initOptions: function(a) { var b, e, f, g;
            ...
            getUnitViewSpec: function(b) { var c, d, e; if (-1 != a.inArray(b, Ya))
                    for (c = this.header.getViewsWithButtons(), a.each(Ta.views, function(a) { c.push(a) }), d = 0; d < c.length; d++)
    ...
    Ta.datepickerLang = function(b, c, d) {
        ...
        Ta.lang = function(b, d) { var e, f;
            e = wb[b] || (wb[b] = {}), d && (e = wb[b] = c([e, d])), f = Pa(b), a.each(yb, function(a, b) { null == e[a] && (e[a] = b(f, e)) }), vb.defaults.lang = b };
    ...
    var xb = {
            ...
            monthYearFormat: function(a) { return a.showMonthAfterYear ? "YYYY[" + a.yearSuffix + "] MMMM" : "MMMM YYYY[" + a.yearSuffix + "]" }
        },
        yb = {
            ...
            noMeridiemTimeFormat: function(a) { return a.longDateFormat("LT").replace(/\s*a$/i, "") }
        },
        zb = {
    ...
    vb.prototype.getPeerEvents = function(a, b) { var c, d, e = this.getEventCache(),
    ...
    var Cb = Ta.BasicView = tb.extend({
            ...
            /* Scroll
            	------------------------------------------------------------------------------------------------------------------*/
            queryScroll: function() { return this.scroller.getScrollTop() },
            setScroll: function(a) { this.scroller.setScrollTop(a) },
            /* Hit Areas
            	------------------------------------------------------------------------------------------------------------------*/
        ...
        Db = {
            ...
            renderIntroHtml: function() { var a = this.view; return a.weekNumbersVisible ? '<td class="fc-week-number" ' + a.weekNumberStyleAttr() + "></td>" : "" }
        },
        Eb = Ta.MonthView = Cb.extend({
            ...
            setGridHeight: function(a, b) { b = b || "variable" === this.opt("weekMode"), b && (a *= this.rowCnt / 6), i(this.dayGrid.rowEls, a, !b) },
    ...
    Ua.basic = { "class": Cb }, Ua.basicDay = { type: "basic", duration: { days: 1 } }, Ua.basicWeek = { type: "basic", duration: { weeks: 1 } }, Ua.month = {
        "class": Eb,
    ...
    var Fb = Ta.AgendaView = tb.extend({
            ...
            instantiateDayGrid: function() { var a = this.dayGridClass.extend(Hb); return new a(this) },
            /* Rendering
            	------------------------------------------------------------------------------------------------------------------*/
            // Sets the display range and computes all necessary dates
            setRange: function(a) {
        ...
        Gb = {
            ...
            renderIntroHtml: function() { var a = this.view; return '<td class="fc-axis" ' + a.axisStyleAttr() + "></td>" }
        },
        Hb = {
        ...
        Ib = 5,
        Jb = [{ hours: 1 }, { minutes: 30 }, { minutes: 15 }, { seconds: 30 }, { seconds: 15 }];
    return Ua.agenda = { "class": Fb, defaults: { allDaySlot: !0, allDayText: "all-day", slotDuration: "00:30:00", minTime: "00:00:00", maxTime: "24:00:00", slotEventOverlap: !0 } }, Ua.agendaDay = { type: "agenda", duration: { days: 1 } }, Ua.agendaWeek = { type: "agenda", duration: { weeks: 1 } }, Ta
});